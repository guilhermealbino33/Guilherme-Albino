...
public class Desafio06 {
	...
	case 5:
		...
		num1 = Double.parseDouble(JOptionPane.showInputDialog("Digite o primeiro número da POTÊNCIA: "));
		num2 = Double.parseDouble(JOptionPane.showInputDialog("Digite o segundo número da POTÊNCIA: "));

		
		resultado = Math.pow(num1, num2);

		JOptionPane.showMessageDialog(null,"POTÊNCIA: \n"+ num1+" ÷ "+num2+" = "+resultado);
